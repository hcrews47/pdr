// Holt Crews, jhc6we, 9/7/17, ListTest.cpp
...
*/
{
    ...
    while (1) {
        ...
        switch (command) {
            ...
            case 2:                        // New list
                if (list != NULL) delete list;
                list = new List; // "list" already created, it's a null pointer
		// Here it is set as dynamic memory with the default constructor
